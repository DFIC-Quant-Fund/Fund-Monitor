...
class Benchmark:
    ...
    def get_spy_benchmark(self):
        ...
        dividend_df = pd.read_csv(os.path.join(self.OUTPUT_PATH, 'dividend_income.csv'))[['Date', 'SPY']]
    ...
    #     custom_benchmark.to_csv(os.path.join(self.OUTPUT_PATH, 'portfolio_total.csv'), index=True)
